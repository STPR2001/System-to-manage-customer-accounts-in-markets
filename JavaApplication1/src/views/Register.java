...
public class Register extends javax.swing.JFrame {
    ...
    private IEmployeeController ICE;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingresar datos de la nueva cuenta");
        ...
        jLabel6.setText("Id Organizacion :");
    ...
    private void createAccount(){
        ...
        String limitAmount = jTextField3.getText();
        String userId = jTextField4.getText();
        String organizationId = jTextField5.getText();
        String paymentInterval = jTextField6.getText();
        
        // this.ICA.createAccount(total, limitAmount, userId, organizationId, paymentInterval, hashedPwd);
        dispose();
        
        
    }
    
    public String generarPwdEncriptada (String password){
        String salt = BCrypt.gensalt(123);//Guardar de forma oculta el int en variables de entorno .properties
    ...
    private void createEmployee(){
        ...
        this.ICE = Factory.getInstance().getEmployeeController();
